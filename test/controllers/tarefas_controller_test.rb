...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post tarefas_url, params: { tarefa: { data: @tarefa.data, descricao: @tarefa.descricao, prioridade: @tarefa.prioridade, responsavel_id: @tarefa.responsavel_id, status: @tarefa.status, titulo: @tarefa.titulo } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { data: @tarefa.data, descricao: @tarefa.descricao, prioridade: @tarefa.prioridade, responsavel_id: @tarefa.responsavel_id, status: @tarefa.status, titulo: @tarefa.titulo } }
